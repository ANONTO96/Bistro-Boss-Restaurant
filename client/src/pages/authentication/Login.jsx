...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // navigating to the page where user was 
          ...
          <form onSubmit={handleSignIn}>
            ...
            <div className='mt-4'>
              ...
              <input ref={captchaRef}
                name='captcha'
                className='block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300'
                type='text' placeholder='type the text above'
              />
              <button type='button' onClick={handleValidateCaptcha} className='btn btn-outline text-white btn-xs mt-2 w-full bg-gray-600'>Validate</button>
            </div>
